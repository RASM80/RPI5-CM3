...
video_config = picam2.create_video_configuration(
    ...
    controls={
        ...
        "HdrMode": libcamera.controls.HdrModeEnum.MultiExposure,  # Default: Off; Range: Enum (Off, MultiExposure, etc.); Controls HDR
...
picam2.set_controls({
    ...
    "ExposureValue": 0.0,  # Default: 0.0 (auto if AeEnable=True); Range: -8.0 to 8.0; Exposure compensation
    ...
    "NoiseReductionMode": libcamera.controls.draft.NoiseReductionModeEnum.Fast,  # Default: Fast; Range: Enum (Off, Fast, HighQuality); Noise reduction
    "Sharpness": 1.0,      # Default: 1.0; Range: 0.0-16.0; Image sharpness
    "ColourGains": (1.0, 1.0)  # Default: (1.0, 1.0); Range: Tuple of two floats (0.0-16.0); Manual red/blue gains (used if AwbEnable=False)
})
